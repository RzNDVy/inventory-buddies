...
interface SearchFilterProps {
  ...
  statusFilter: 'all' | 'Ada' | 'Hilang';
  onStatusChange: (status: 'all' | 'Ada' | 'Hilang') => void;
}
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Select value={statusFilter} onValueChange={onStatusChange}>
            <SelectTrigger className="w-32 rounded-xl border-2 bg-card">
              <SelectValue placeholder="Status" />
            </SelectTrigger>
            <SelectContent className="rounded-xl bg-card border-2 border-border z-[100]">
              <SelectItem value="all" className="rounded-lg">Semua</SelectItem>
              <SelectItem value="Ada" className="rounded-lg">Ada</SelectItem>
              <SelectItem value="Hilang" className="rounded-lg">Hilang</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
