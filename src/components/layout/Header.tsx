        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Kelola barangmu dengan ceria!</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Notification button */}
            <button className="w-12 h-12 bg-card rounded-2xl flex items-center justify-center shadow-cute border-2 border-border/50 hover:scale-105 transition-transform relative">
